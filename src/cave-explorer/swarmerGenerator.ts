...
export function spawnSwarmer(
  ...
  const swarmerWidth = GAME_CONSTANTS.PLAYER_WIDTH * GAME_CONSTANTS.LEVIATHAN_WIDTH_MULTIPLIER;
  const swarmerHeight = GAME_CONSTANTS.PLAYER_HEIGHT * GAME_CONSTANTS.LEVIATHAN_HEIGHT_MULTIPLIER;
